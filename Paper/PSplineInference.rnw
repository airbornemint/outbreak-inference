...
\begin{itemize}
\item Correctness: the fraction of $95$\% confidence intervals that (correctly) include the true value of the outcome measure
...
Fractional bias direction  	   &  $\Sexpr{ifelse(validationResults$summary$onset.bias.frac.sign > 0, "+", "-")}$ & $\Sexpr{ifelse(validationResults$summary$offset.bias.frac.sign > 0, "+", "-")}$ & ---
\end{tabular}
\end{table}
