...
Season offset 		&  \Sexpr{round(100*validationResults$summary$offset.good, 2)} & $\Sexpr{round(100*validationResults$summary$offset.bias, 2)} \pm \Sexpr{round(100*validationResults$summary$offset.bias.se, 2)}$ &  &  \\ \hline
