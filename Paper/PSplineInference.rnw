...
Season onset 		&  \Sexpr{round(100*validationResults$summary$onset.good, 2)} & $\Sexpr{round(100*validationResults$summary$onset.bias, 2)} \pm \Sexpr{round(100*validationResults$summary$onset.bias.se, 2)}$ weeks &  &  \\ \hline
Season offset 		&  \Sexpr{round(100*validationResults$summary$offset.good, 2)} & $\Sexpr{round(100*validationResults$summary$offset.bias, 2)} \pm \Sexpr{round(100*validationResults$summary$offset.bias.se, 2)}$ weeks &  &  \\ \hline
