...
seriousEst <- model %>%
  outbreak.estimate.timeseries(modelTime, seriousDiseaseCases(progressionRate=0.8, treatmentSuccessRate=0.9, treatmentMax=100, sampleFreq=sampleFreq), samples=n, level=0.95)
```
...
preventableEst <- outbreak.estimate.scalars(model, modelTime, preventableFraction(ppxStart=20, ppxDuration=24))
