...
limitCores = ifelse(as.logical(Sys.getenv("_R_CHECK_LIMIT_CORES_", "FALSE")), 2, NA)
registerDoParallel(min(detectCores(), limitCores, na.rm=TRUE))
...
kable_styling(
  kable(
    validationResults$summary$supply.duration.good, 
