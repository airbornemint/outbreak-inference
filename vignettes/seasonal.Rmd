...
```{r estimate cum cases, include=FALSE, eval=vignette.eval.full}
...
```{r custom est parameterized, include=FALSE, eval=vignette.eval.full}
seriousEst <- model %>%
...
```{r validate supply duration, include=FALSE, eval=vignette.eval.full}
set.seed(0)
