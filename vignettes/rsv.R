...
## ----plot cases splines, include=TRUE------------------------------------
nSmall = 15
...
## ----predict cum cases, include=TRUE-------------------------------------
...
## ----plot onset distribution, include=TRUE-------------------------------
...
## ----custom outcome function, include=TRUE-------------------------------
ppxStart = 20 # weeks
...
## ----custom outcome estimate, include=TRUE-------------------------------
...
## ----custom outcome distribution, include=TRUE, fig.width=2, fig.height=6----
